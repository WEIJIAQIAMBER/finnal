...
function changeYear(year){
    ...
    var CSV2015 = 'bubbleSKTpick2015.csv';
    var CSV2016 = 'bubbleSKTpick2016.csv';
    var CSV2017 = 'bubbleSKTpick2017.csv';
...
//set bubble padding
        ...
        function showPopover(d) {
            $(this).popover({
                ...
                html: true,
                content: function() {
                    return  d.teamTag + "'s Ban Champion in "+ d.year + "\n"+"</br>Champion Name: " + d.championName + "</br>Number Of Bans: " + d.banNumber + "</br>Percentage Of Winning: " + d.winningPercentage;
                }
            });
            $(this).popover('show');
        }
